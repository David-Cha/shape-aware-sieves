...
def main(args, result_name):
  ...
  meshes_A_use_edge_splitting_flags = [False]
  meshes_A_use_smooth_shading_flags = [False]
  meshes_B_use_edge_splitting_flags = [False]
  meshes_B_use_smooth_shading_flags = [False]
...
if __name__ == '__main__':
  result_name = 'arch_vs_rect_prism_less_PSO_iters'

...
def main(args, result_name):
  ...
  meshes_A_use_edge_splitting_flags = [True, True, True]
  meshes_A_use_smooth_shading_flags = [False, False, False]
  meshes_B_use_edge_splitting_flags = [True, True, True, True]
  meshes_B_use_smooth_shading_flags = [False, False, False, False]
...
if __name__ == '__main__':
  result_name = 'siggraph_multi_A_multi_B'

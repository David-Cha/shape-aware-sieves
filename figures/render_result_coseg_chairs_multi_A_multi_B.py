...
def main(args, result_name):
  ...
  render.render_sieve_mesh(result_name, cam_location=(3.5, 0., 2.5))
...
if __name__ == '__main__':
  result_name = 'coseg_chairs_multi_A_multi_B'
